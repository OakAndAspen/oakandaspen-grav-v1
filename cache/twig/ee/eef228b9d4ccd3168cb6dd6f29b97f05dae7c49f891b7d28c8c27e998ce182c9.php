...
class __TwigTemplate_2c3e2e5895380356b28370adc79855aebc3675ada407e3bd3816da4ce3ad70a4 extends \Twig\Template
{
    ...
    <div class=\"footer-items\">
        ...
        echo "</a></h3>
            ...
            ";
        // line 7
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "fr", []), "description", [])) {
            // line 8
            echo "                <p>";
            echo $this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "fr", []), "description", []);
            echo "</p>
            ";
        }
        // line 10
        ...
        // line 11
        echo $this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "fr", []), "contact_title", []);
        echo "</h4>
            <p>
                ";
        // line 13
        ...
        <div class=\"footer-module\"><h4>";
        // line 20
        echo $this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "fr", []), "social_title", []);
        echo "</h4>
            <div class=\"logo\">
                ";
        // line 22
        ...
        <div class=\"footer-module\"><h4>";
        // line 27
        echo $this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "fr", []), "language_title", []);
        echo "</h4>
    ...
    <div class=\"footer-items\">
        <div class=\"footer-module large\">
            ...
            {% if site.footer.fr.description %}
                <p>{{ site.footer.fr.description }}</p>
            {% endif %}
        </div>
        <div class=\"footer-module\"><h4>{{ site.footer.fr.contact_title }}</h4>
            <p>
        ...
        <div class=\"footer-module\"><h4>{{ site.footer.fr.social_title }}</h4>
            <div class=\"logo\">
                {% block social %}
        ...
        <div class=\"footer-module\"><h4>{{ site.footer.fr.language_title }}</h4>
            <ul style=\"list-style-type: none; list-style-position: inside; margin: 0;\">
                <li><a href=\"/en\">English</a></li>
                <li><a href=\"/fr\">Français</a></li>
            </ul>
...
</div>", "modular/footer.html.twig", "C:\\xampp\\htdocs\\oakandaspen-grav-v1\\user\\themes\\deliver\\templates\\fr\\modular\\footer.html.twig");
    }
}
